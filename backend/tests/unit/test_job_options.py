...
from lvt.core.platform_runtime import RuntimePlatform, default_asr_model
...
def test_default_asr_model_is_selected_by_runtime_platform() -> None:
    assert default_asr_model(RuntimePlatform.MACOS) == "mlx-community/whisper-small-mlx"
    assert default_asr_model(RuntimePlatform.WINDOWS) == "Systran/faster-whisper-small"
    assert default_asr_model() == DEFAULT_ASR_MODEL
